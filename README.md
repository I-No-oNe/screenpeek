...
Linux needs a Wayland compositor with `wlr-virtual-pointer` and `virtual-keyboard` for input — Hyprland, Sway, river and the other wlroots compositors have both. X11 and Windows work as they are.
